...
parser.add_argument('--exp', type=str, default='train_cfcmb_2_1_8', help='model_name')
...
parser.add_argument('--temperature', type=float, default=0.5, help='伪标签温度缩放')
parser.add_argument('--base_threshold', type=float, default=0.8, help='基础置信度阈值')
...
parser.add_argument('--teacher_alpha', type=float, default=0.995, help='教师模型EMA系数')

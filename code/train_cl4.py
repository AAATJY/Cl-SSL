...
14000轮16/64[0.91769156 0.84845066 4.95492703 1.65828543]目前达到最好结果(2500轮启用，edge_threshold=0.4)
"""
...
parser.add_argument('--exp', type=str, default='train_cl4_1', help='model_name')
...
parser.add_argument('--contrast_start_iter', type=int, default=2501, help='启用对比学习的迭代次数')
